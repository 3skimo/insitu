...
static void LoadShaders() {
    ...
    glm::mat4 camera = glm::lookAt(glm::vec3(3883.16,78.101,5047.701), glm::vec3(3880.16,75.101,5044.701), glm::vec3(0,1,0));
...
static void Render() {
    ...
    gProgram->setUniform("model", glm::translate(glm::mat4(), glm::vec3(3880.16,75.101,5044.701)));
